...
(1, 'Paper Rex', 'Singapore', 'Paper Rex adalah salah satu tim Valorant paling ikonik di APAC, terkenal dengan gaya bermain yang agresif dan kreatif. Mereka sering tampil memukau di turnamen regional maupun internasional, membawa nama Singapore ke level tinggi dan selalu menjadi favorit fans di setiap kompetisi.', 'https://liquipedia.net/commons/images/7/7b/Paper_Rex_darkmode.png', 'Group A'),
